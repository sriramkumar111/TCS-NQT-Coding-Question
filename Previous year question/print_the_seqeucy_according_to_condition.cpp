...
/*
Task 1- print the collatz sequence upto ending with 1 the sequence should be 
...
Task-2
For the given integer from 1,n it should calculate the sequence of each k 
value l.e, 1<=k<=n

Calculate the maximum length of sequence list of each k value and
return the maximum length of the sequence list of the k value and the k value 
itself

Task-3
For the given integer from 1 tjo n it should calculate the sequence of each'k value 
le, 1<=k<=n Calculate the maximum value of the each sequence within the sequence
 list of each k value and return the maximum value of the sequence list of the k 
value and those k value itself.
